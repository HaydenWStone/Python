"
This script conducts a twitter query every hour via the Twitter API and sends a summary email with a CSV attachment with all relevent tweets every 24 hours
"
